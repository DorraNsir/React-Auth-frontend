    ...
    return (
        <>
            ...
            <div className='flex items-center justify-center'>
                <h3 className="text-gray-700 text-2xl font-extrabold">Choose your template</h3>
                {/* <span className="mt-3 text-sm text-gray-500">200+ template</span> */}
            </div>
            <div className="px-6 my-2 bg-slate-100 relative justify-center items-center w-1/2  mx-auto lg:h-72 rounded-3xl filter drop-shadow-2xl " style={{backgroundImage:`url(${hoverImage})`}}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-8 mx-auto max-w-7xl">
                ...
                <div className="rounded-md overflow-hidden shadow-lg hover:shadow-xl  filter hover:drop-shadow-2xl transform transition duration-500 ease-in-out hover:scale-105">
                    <div
                        ...
                        onMouseEnter={() => setHoverImage("https://cdn.discordapp.com/attachments/1138848747665768499/1202924542360821820/landingImage.png?ex=65cf39c8&is=65bcc4c8&hm=1b99058f59c8fe4c22ed916af1636f203ce951db40ac67e195b70f7de3516fe5&")}
